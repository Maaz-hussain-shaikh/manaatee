...
const Userlist = () => {
  ...
  const URL = "https://aaliyaenterprises.com/manaatee/Api/Users/all_user";
              ...
              <tbody className="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                {loading ? (
                  ...
                  data[currentPage]?.data.map((elem, index) => {
                    ...
                    return (
                        <tr className="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400" key={index} onClick={()=>{locate(`/userdetails/${elem.user_id}`)}}>
                        ...
                        <td className="px-4 py-3 text-xs">
                          <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"> {elem.status}</span>
                        </td>
